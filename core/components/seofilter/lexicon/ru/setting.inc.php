...
$_lang['setting_seofilter_separator_desc'] = 'По умолчанию "-", по нему идёт разбивка значения от параметра. Не рекомендуется изменять.';
...
$_lang['setting_seofilter_count_desc'] = 'По умолчанию да. Если да, то будет доступен плейсхолдер {$count} в SEO шаблонах';
...
$_lang['setting_seofilter_crumbs_tpl_current_desc'] = 'По умолчанию "tpl.SeoFilter.crumbs.current". Для вложенных крошек используйте чанк "tpl.SeoFilter.crumbs.nested" и не забудьте прописать этот же чанк в параметр tplCurrent в pdoCrumbs.';
...
$_lang['setting_seofilter_pro_mode'] = 'Включить продвинутый режим';
$_lang['setting_seofilter_pro_mode_desc'] = 'Активирует возможность прикреплять правило к нескольким страницам, в дальнейшем что-то ещё добавится';
$_lang['setting_seofilter_url_scheme'] = 'Схема формирования ссылки на страницы, куда будут добавляться SEO-ссылки';
...
$_lang['setting_seofilter_crumbs_nested'] = 'Вложенные хлебные крошки из SEO-страниц';
$_lang['setting_seofilter_crumbs_nested_desc'] = 'Активирует вложенность виртуальных страниц для хлебных крошек. Пропишите в настройке <b>seofilter_crumbs_tpl_current</b> новый чанк <b>tpl.SeoFilter.crumbs.nested</b> и в параметр <b>tplCurrent</b> в вызове pdoCrumbs';