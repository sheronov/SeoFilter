...
$_lang['setting_seofilter_decline_desc'] = 'По умолчанию нет, для склонения используется сервис morpher.ru (Лимит бесплатных запросов - 100 в сутки)';
...
$_lang['setting_seofilter_separator_desc'] = 'По умолчанию "-", по нему идёт разбивка значения слова от псевдонима. Учитывается при сохранении правила.';
...
$_lang['setting_seofilter_crumbs_replace'] = 'Заменять хлебные крошки через Ajax';
$_lang['setting_seofilter_crumbs_replace_desc'] = 'По умолчанию да. Можно выключить, если не используете хлебные крошки';
...
$_lang['setting_seofilter_url_scheme'] = 'Схема формирования ссылки на привязанным к правилам страницам';
...
$_lang['setting_seofilter_level_separator_desc'] = 'По умолчанию "/". Внимание! Добавив дефис или другой разделитель не будет "вложенности" через слэш. ';
$_lang['setting_seofilter_between_urls'] = 'Разделитель между адресом страницы и SEO-ссылками';
$_lang['setting_seofilter_between_urls_desc'] = 'По умолчанию "/". Внимание! С помощью этой настройки можно сделать ссылки в один уровень, добавив дефис.';
...
$_lang['setting_seofilter_content_ace'] = 'Список полей, где нужно подключить редактор кода (Ace)';
$_lang['setting_seofilter_content_ace_desc'] = 'По умолчанию: "content,Rule.content" добавит редактор кода Ace к текстовым полям. Приставка "Rule." для полей правила. Через двоеточие можно указать высоту поля: "introtext:100"';
$_lang['setting_seofilter_content_richtext'] = 'Список полей, где нужно подключить визуальный редактор';
$_lang['setting_seofilter_content_richtext_desc'] = 'Приоритетнее редактора кода. Пример: "introtext,content" добавит визуальный редактор при редактировании ссылки. Для подключения к текстовым полям правила добавьте спереди "Rule."';
$_lang['setting_seofilter_admin_version'] = 'Версионирование скриптов в админ-панели';
$_lang['setting_seofilter_admin_version_desc'] = 'По умолчанию включено. Отключите, если есть проблемы при сжатии скриптов';
$_lang['setting_seofilter_collect_words'] = 'Собирать изменения в полях при сохранении ресурсов';
$_lang['setting_seofilter_collect_words_desc'] = 'По умолчанию включено. И если включены подсчёты - то сразу же происходит пересчёт результатов по ссылкам. Отключите, если есть длительные задержки при сохранении ресурсов';
$_lang['setting_seofilter_edit_url_mask'] = 'Разрешить редактирование url-маски в правиле';
$_lang['setting_seofilter_edit_url_mask_desc'] = 'По умолчанию отключено. Экспериментальная настройка, никаких проверок на корректность маски пока нет';
$_lang['setting_seofilter_ajax_recount'] = 'Пересчитывать результаты при каждом ajax запросе страницы';
$_lang['setting_seofilter_ajax_recount_desc'] = 'По умолчанию нет. Если нет - то будут пересчитываться только страницы с 0 результатами. Если да, то при каждом ajax запросе';