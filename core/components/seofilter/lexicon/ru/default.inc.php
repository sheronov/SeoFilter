...
$_lang['seofilter_fields_intro'] = 'На этой странице нужно добавить поля, которые вы хотите использовать для формирования SEO правил. Синоним поля должен соответсвовать синониму в фильтре.';
...
$_lang['seofilter_urls_intro'] = 'После добавления правил здесь автоматически появляются адреса и статистика по переходам. Для каждой страницы можно также индивидуально задать уникальный адрес, SEO и meta поля';
