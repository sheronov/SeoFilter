...
$_lang['seofilter_fields_intro'] = 'На этой странице нужно добавить поля, которые вы хотите использовать для формирования SEO правил. Синоним поля должен соответсвовать синониму в фильтре. После добавления поля автоматически собираются значения в словарь на третьей вкладке';
...
$_lang['seofilter_dictionary_intro'] = 'После добавления поля здесь появляются запросы и их склонения (если включена соответствующая настройка в настройках). Слова можно откорректировать в ручную, при изменении синонима происходит автоматическая регенерация страниц в таблицу URL. Если необходимо, то можно в ручную добавить слова к полям';

$_lang['seofilter_urls'] = 'Таблица URL';
$_lang['seofilter_urls_intro'] = 'После добавления правил здесь автоматически появляются адреса и статистика по переходам. Для каждой страницы можно также индивидуально задать уникальный адрес, SEO и meta поля или вовсе отключить.';
...
$_lang['seofilter_fieldids_alias'] = 'Синоним';
...
$_lang['seofilter_url_link'] = 'Название ссылки';
...
$_lang['seofilter_multiseo_intro'] = 'Синтаксис для прописывания динамических значений в шаблоны: {$alias}, {$alias_r}, {$m_alias} и т.д. где "alias" - это синоним поля, добавленный в первой влкадке. Падежи добавляются с припиской "_d", "_v" и т.д. Множественное число с приставкой "{$m_".';
...
$_lang['seofilter_compare_in'] = 'Содержится';
$_lang['seofilter_compare_notin'] = 'Не содержится';
...
$_lang['seofilter_rule_recount_message'] = '<br><b>Подсчёты результатов:</b><br>Всего ссылок связанных с правилом: {$all_links}. <br> Cсылок, имеющих результаты: <b>{$links}</b>. <br> Количество результатов (не уникальных): {$total}. ';
