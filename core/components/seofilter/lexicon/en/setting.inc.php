...
$_lang['setting_seofilter_pro_mode'] = 'Activate PRO mode';
$_lang['setting_seofilter_pro_mode_desc'] = 'Enables the ability to add multiple pages to a rule, separated by commas';
...
$_lang['setting_seofilter_level_separator'] = 'Separator of nesting in SEO-links';
...
$_lang['setting_seofilter_main_alias'] = 'Add a alias for the main page to the URL';
$_lang['setting_seofilter_main_alias_desc'] = 'By default "No". Used when the main page has SEO-rule and you need links in one level';
