...
$_lang['setting_seofilter_decline_desc'] = 'Default no, declination uses the service morpher.ru (Limit of free requests - 100 per day)';
...
$_lang['setting_seofilter_crumbs_nested'] = 'Nested crumbs of SEO-pages';
$_lang['setting_seofilter_crumbs_nested_desc'] = 'Activates the nesting of virtual pages for breadcrumbs. Register in the <b>seofilter_crumbs_tpl_current</b> setting the new chunk <b>tpl.SeoFilter.crumbs.nested</b> and in the <b>tplCurrent</b> parameter in the pdoCrumbs call';
$_lang['setting_seofilter_content_ace'] = 'List of fields where you need to connect the code editor (Ace)';
$_lang['setting_seofilter_content_ace_desc'] = 'Default: "content, Rule.content" will add the Ace code editor to the text fields. The prefix "Rule." for rule fields. After the colon, you can specify the height of the field: "introtext: 100"';
$_lang['setting_seofilter_content_richtext'] = 'List of fields where you need to connect the visual editor';
$_lang['setting_seofilter_content_richtext_desc'] = 'Priority code editor. Example: "introtext, content" will add a visual editor when editing a link. To connect to the text fields of the rule, add "Rule."';
$_lang['setting_seofilter_admin_version'] = 'Versioning scripts in the admin panel';
