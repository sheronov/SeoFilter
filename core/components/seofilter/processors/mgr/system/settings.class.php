...
class sfSettingsSaveProcessor extends modProcessor
{
    ...
    public  $booleans = array(
        'main_alias','url_redirect','count','hide_empty','ajax','decline','crumbs_nested','crumbs_replace','replacebefore',
        'pro_mode','last_modified','replace_host','mfilter_words','hidden_tab','admin_version','collect_words'
    );
